            ...
            <Row>
                <div className="col-lg-6 col-md-6 col-sm-12 d-flex align-items-center">
                    <div className='w-100'>
                        ...
                        <h2 className='mb-5 border-bottom border-3 rounded-pill text-center px-3 pb-2'>
                            <span className='text-info'>
                                <Typewriter
                                    words={['I am a Front-end Web Developer', 'And a Graphics Designer']}
                                    loop={5}
                                    cursor
                                    cursorStyle='_'
                                    typeSpeed={70}
                        ...
                        <div className='text-center'>
                            <a href="https://drive.google.com/file/d/1gVa-6U4ZObPTW8_3ptpkK00vC9oIgO66/view?usp=sharing" download="resume.pdf" target="_blank" className="text-decoration-none border btn btn-outline-info rounded-pill border-info">
